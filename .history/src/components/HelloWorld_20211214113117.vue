    ...
    const searchOne = () => {
      ...
      if (state.searchKey != null) {
        state.searchList.map((item) => {
          if (item.value == state.searchKey) {
            console.log("state.searchKey;---", state.searchKey);
            state.list = [];
            state.list[0] = item;
          }
        });
        console.log("1list--", state.list);
        console.log("1searchList--", state.searchList);
      } else {
        console.log("2list--", state.list);
        console.log("2searchList--", state.searchList);
        state.list = [];
