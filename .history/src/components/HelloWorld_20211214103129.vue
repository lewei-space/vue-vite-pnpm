  ...
  <el-container>
    ...
    <el-container>
      <el-header>
        <el-row :gutter="20">
          <el-col :span="20">
            <el-input v-model="state.inputNum" placeholder="Please input" />
          </el-col>
          <el-col :span="4">
      ...
      <el-main>
        ...
        <el-dialog
          ...
          width="50%"
        >
          <el-form label-position="top" label-width="100px" :model="state.oneData">
            <el-form-item label="Name">
              <el-input v-model:value="state.oneData.name"></el-input>
            </el-form-item>
            <el-form-item label="Value">
              <el-input v-model:value="state.oneData.value"></el-input>
            </el-form-item>
          </el-form>
          <template #footer>
...
function inputNum(inputNum: any) {
...
function inputNum(arg0: string, state: { list: any[]; }, inputNum: any) {
  throw new Error("Function not implemented.");
}
